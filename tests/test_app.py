...
l1 = st.sidebar.selectbox("Level 1 (e.g., Income)", all_cols, index=all_cols.index(guess(all_cols, ["Income"])) if all_cols else 0)
l2 = st.sidebar.selectbox("Level 2 (e.g., Category)", all_cols, index=all_cols.index(guess(all_cols, ["Category"])) if all_cols else 0)
