...
def prepare_sankey_data(df: pd.DataFrame, l1: str, l2: str, l3: str, value_col: str) -> Dict[str, List]:
    # Validate
...
def make_sankey_figure(sankey_data: Dict[str, List], title: str = "Three-Level Sankey") -> go.Figure:
